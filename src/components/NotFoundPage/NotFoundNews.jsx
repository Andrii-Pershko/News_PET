    ...
    <div className="error">
      ...
      <picture>
        <source
          ...
          srcSet={`${require('../../img/not_found_mobile@1.png')}  1x, ${require('../../img/not_found_mobile@2.png')}  2x`}
          sizes="768px"
        />
        <source
          media="(max-width: 1279px)"
          srcSet={`${require('../../img/not_found_table@1.png')}  1x, ${require('../../img/not_found_table@2.png')}  2x,`}
          sizes="1279px"
        />
        <source
          srcSet={`${require('../../img/not_found.webp')} 1x, ${require('../../img/not_found@x2.webp')} 2x,`}
          sizes="1280px"
        />
